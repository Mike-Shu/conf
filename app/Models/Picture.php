...
class Picture extends Model
{
    ...
    public function getRawAttribute(): ?string
    {
        if ($this->content->has('raw')) {
            return isset($this->local_file_path)
                ? tenant_asset($this->content->get('raw'))
    ...
    public function getLargeAttribute(): ?string
    {
        if ($this->content->has('large')) {
            return isset($this->local_file_path)
                ? tenant_asset($this->content->get('large'))
    ...
    public function getMediumAttribute(): ?string
    {
        if ($this->content->has('medium')) {
            return isset($this->local_file_path)
                ? tenant_asset($this->content->get('medium'))
    ...
    public function getThumbnailAttribute(): ?string
    {
        if ($this->content->has('thumbnail')) {
            return isset($this->local_file_path)
                ? tenant_asset($this->content->get('thumbnail'))
    ...
    {
        if ($this->content->has('thumbnail_square')) {
            return isset($this->local_file_path)
                ? tenant_asset($this->content->get('thumbnail_square'))
                : $this->content->get('thumbnail_square');
        }
