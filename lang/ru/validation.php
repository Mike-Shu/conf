...
return [
    ...
    'phone' => 'Поле :attribute содержит некорректный телефон.',
    ...
    'domain' => 'Такое значение поля :attribute недоступно.',
    'custom' => [
        'attribute-name' => [
    ...
    'attributes' => [
        ...
        'domain' => 'Домен',
        'user_result_image' => 'Изображение',
        'user_result_video' => 'Видео',
        'organization' => 'Подразделение',
        'terms' => 'Условия обслуживания и Политика конфиденциальности',
        ...
        'email_or_phone' => "E-Mail адрес или номер телефона",
        'status' => "Статус",
        'reason' => "Причина",
        'comment' => "Комментарий",
        'type' => "Тип",
        'video_provider' => "Видео-провайдер",
        'video_identifier' => "Идентификатор видео",
        'points' => "Баллов",
    ],
];
